...
xhr.send(null);
  ...
  const handleSendAmountToAddress = async () => {
    var amt =  document.getElementById("amtCUSD").value;
    alert(`Address: ${address} | Amt: ${amt}`);
                ...
                <form onSubmit = {() => setCurrent(false)} className={styles.number_form}>
                    <div className={styles.flexContainer}>
                      ...
                      <br />
                        ...
                        <button type = "submit" onClick={retrieveAddr} className = {styles3.submitButton}>Proceed</button>
                                  </div>
                ...
                <form onSubmit = {() => {
                     ...
                     <section className={styles.phoneNumber}>
                             <div className={styles.flexContainerCountry}>
                                ...
                                <section>
                                    <input id='amtCUSD' onChange = {(e) => setAmount(parseInt(e.target.value))} value = {amount} className={styles.inputForm} type='number' autoFocus/>
                                </section>
                            </div>
                        </section>
                          <br />
                          ...
                          <br />
                                   ...
                                   <div className = {styles3.submitSection}>
                        <button onClick={handleSendAmountToAddress} className = {styles3.submitButton}>Confirm transaction</button>
      ...
      <BrowserRouter>
       ...
       <Routes>
        ...
        <Route path="/payments" element={<></>} />
         ...
         <Route path="/savings-borrowings" element={<Layout><Saving /></Layout>} />
         <Route path="/send" element={<Send />} />
         <Route path="/payments-qr" element={<QRScan />} />
...
function Box() {
  ...
  <div className={"container"+styles.login} >
      <h1 className="text-center text-white" id="loginTitle">Register</h1>
      <br/>
...
function Box2() {
  return (
   <div id="loginBox" className={"container"+styles.login}>
      <h1 className="text-center text-white" id="loginTitle">Login</h1>
      <br/>
      ...
      <div className={styles.socialsDiv} >
       ...
       &nbsp;
        &nbsp;
         &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <button onClick={() => loginSocial("google")} className={styles.socials}> &nbsp;
        <img src="https://dashboard.web3auth.io/img/login-google.2a082e2a.svg"/>
      </button>
            <button onClick={() => loginSocial("linkedin")} className={styles.socials}> &nbsp;
        <img src="https://dashboard.web3auth.io/img/login-linkedin.a1413fd9.svg"/>
      </button>
       <button onClick={() => loginSocial("discord")}  className={styles.socials}> &nbsp;
        <img src="https://dashboard.web3auth.io/img/login-discord.0321a3e0.svg" />
      </button>
      <button onClick={() => loginSocial("facebook")} className={styles.socials}> &nbsp;
        <img src="https://dashboard.web3auth.io/img/login-facebook.01f67d62.svg" />
      </button> &nbsp;
      <button onClick={() => loginSocial("twitter")} className={styles.socials}> &nbsp;
        <img src="https://dashboard.web3auth.io/img/login-twitter.d24e7883.svg"/>
      </button>
      </div>

        <form onSubmit={(e)=>handleLoginWithEmail(e)}  className={"container"+styles.login2}>
      <div className="text-center">
        <input type={'email'} placeholder={'Enter your email'} className={styles.input} />
        <button type="submit" className={styles.continue}>Continue</button>
        </div>
...
<div>
      ...
      <div id="firstPg" className="text-center text-white">
         <img src="http://localhost:3000/cat.png" className="rounded mx-auto d-block" alt="..."/>
...
<br/>
<br/>
         <button id="btn" onClick={function(){ handleClick(); changeState() ;}} className={styles.buttonC}>
                <a className="text-center fs-5 text-white">Create an Account</a></button>
<br/>      <button id="btn2" onClick={function(){ handleClick2(); changeState2() ;}} className={styles.buttonC}>
